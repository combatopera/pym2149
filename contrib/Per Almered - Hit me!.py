...
bass1 = E(Bass, 2 * ['r.5 r.5 .5 r.5 r.5 .5 r.5 .5 1.5r1|r.5 r.5 .5 r.5 r.5 .5 r.5 4x.5'],
        degree = D('--') + D('2- 2 .5x 2 1.5x2- 2 .5x 1.5x2|2- 2 .5x 2 1.5x2- 2 .5x .5x2 .5x6- .5x'))
bass2 = E(Bass, 'r.5 r.5 .5 r.5 r.5 .5 r.5 4x.5|r.5 r.5 .5 r.5 9x.5',
...
bass7 = E(Bass, '3/4r/4 3xr/4 .5',
        degree = D('2'),
        slap = V('2'))
kick1 = E(Kick, '2')
kick1a = E(Kick, '2',
        np = V('1,7'))
kick2 = E(Kick, '12x .5z /4 3/4 2.5')
kick7 = E(Kick, '/2 /4 /2 /4 2x/2 /4 /2 3/4',
        att = V('.5x 1.5x1 .5x .75x1 .75x'))
snare2 = E(Snare, '13r 1 /4 /2 /4 /2 2x/4',
        att = V('14.25x .75x2 .5x .25x2 .25x'))
snare3 = E(Snare, 'r 3x2 3/4 5/4r1 2x2 5/4 3/4 /2 2x/4')
snare6 = E(Snare, 'r 7x2 3/4 /4')
snare7 = E(Snare2, '/4r 2x3/4 /2 3/4 /2 2x/4',
        att = V('3.5x .25x1 .25x'))
arp1 = E(Arp, '1.5 6.5',
        degree = D('1.5x 6.5x4 1.5x5 6.5x'),
        inv = V('1.5x2 6.5x1 1.5x 6.5x2'))
arp4 = E(Arp, '/4r r/2 /4 3/4r/2 7xr.5 /4 3/4r.5 3xr.5 5/4r3/4 2x3/4r/2',
        degree = D('1.5x 6.5x4 1.5x5 6.5x'),
        inv = V('1.5x2 6.5x1 1.5x 6.5x2'),
        vel = V('0'))
arp6 = E(Arp2, ['.5r .5'] * 27, '.5r 3/4 3.75r',
        degree1 = D('4x 8x6- 4x|5x 7- 2x6- 2x7- 6x6-'),
        degree2 = D('12x2 4x3|5x3 11x2'),
        degree3 = D('6x5 6x4# 4x5|7x5 4# 3x5 5x4#'))
lead4 = E(Lead, '2x3/4 4.75 /4z 3x.5|2x3/4 4.5 2x|1.5 3 .5 4x/4 .5 /4 3x.5 /4 2x.5 /4 .5 /4 .5 /4 .5 /4 .5 /4 .5 /4 .5 /4 .5 /4 1',
...
lead5 = E(Bright, '3.75r .5 /4 .5 /4 3x.5 /4 2x.5|3.75r .5 /4 .5 /4 .5 /4 .5 /4 .5 3x/4',
        degree = D('4.25x2+ .25x6 .5x+ .25x5 .5x6 .5x4 .5x5 .25x6 .5x5 .5x2|4.5x2+ .5x+ .25x6 .5x5 .25x4 .5x5 .25x6 .5x5 .25x4 .25x2 .25x'))
lead6 = E(Luke, [f"/4 2x.5 /4 3x.5 2x/4 .5|/4 2x.5 /4 {x} 2x.5 /4 3/4|/4 2x.5 /4 3x.5 2x/4 .5|/4 2x.5 3x/4 2x.5 /4 .5 /4" for x in ['.5', '2x/4']],
...
lead8 = E(Luke, '62x/4 .5 64x/4',
        att = V('30x// 2x10').of(.25),
        degree = D(['2+ 6+ 2++'] * 10, '2+ 6+', ['+ 5+ ++'] * 10, '2x+').of(.25))
lead9 = E(Lead, ['2x3/4 1 3x.5'] * 2, '1.5 6.5|1.5 3 .5 4x/4 2x3/4 .5 2x3/4 .5 6',
...
luke9 = E(Luke, '12r 16x/4 12.5r 14x/4',
