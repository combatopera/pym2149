...
class Luke:
    ...
    level = V('12 13 14 12 9 2x7 8 7,5'), V('11 12 13 11 9 6 4 2x3 2 1,0'), V('10 11 12 10,8'), V('2x10 11 10,7'), V('2x9 10 9,7'), V('2x8 9 8,6'), V('2x7 8 7,5'), V('6 2x7 6,5'), V('5 2x6 5,4'), V('4 2x5 4,3'), V('3 4x4//4 2,1')
    arp = D('1 +')
...
luke9 = E(Luke, '12/ 16x.25 12.5/ .5 .25 3x.5 5x.25',
        degree = D('48x 4+ 3+ + 6 3+ + 6 4 + 6 4 3 6 4 3 1|64x').of(.25),
        att = V('48x 15x//15 3|61x 8 2x6').of(.25))
A = bass1, kick1, arp1
