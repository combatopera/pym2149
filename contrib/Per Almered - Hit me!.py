...
bass7 = E(Bass, '.75r.25 3xr.25 .5',
        degree = D('2'),
        slap = V('2'))
kick1 = E(Kick, '2')
kick1a = E(Kick, '2',
        np = V('1,7'))
kick2 = E(Kick, '12x .5z .25 .75 2.5')
kick7 = E(Kick, '.5 .25 .5 .25 2x.5 .25 .5 .75',
        att = V('.5x 1.5x1 .5x .75x1 .75x'))
snare2 = E(Snare, '13r 1 .25 .5 .25 .5 2x.25',
        att = V('14.25x .75x2 .5x .25x2 .25x'))
snare3 = E(Snare, 'r 3x2 .75 1.25r1 2x2 1.25 .75 .5 2x.25')
snare6 = E(Snare, 'r 7x2 .75 .25')
snare7 = E(Snare2, '.25r 2x.75 .5 .75 .5 2x.25',
        att = V('3.5x .25x1 .25x'))
arp1 = E(Arp, '1.5 6.5',
        degree = D('1.5x 6.5x4 1.5x5 6.5x'),
        inv = V('1.5x2 6.5x1 1.5x 6.5x2'))
arp4 = E(Arp, '.25r r.5 .25 .75r.5 7xr.5 .25 .75r.5 3xr.5 1.25r.75 2x.75r.5',
        degree = D('1.5x 6.5x4 1.5x5 6.5x'),
        inv = V('1.5x2 6.5x1 1.5x 6.5x2'),
        vel = V('0'))
arp6 = E(Arp2, ['.5r .5'] * 27, '.5r .75 3.75r',
        degree1 = D('4x 8x6- 4x|5x 7- 2x6- 2x7- 6x6-'),
        degree2 = D('12x2 4x3|5x3 11x2'),
        degree3 = D('6x5 6x4# 4x5|7x5 4# 3x5 5x4#'))
lead4 = E(Lead, '2x.75 4.75 .25z 3x.5|2x.75 4.5 2x|1.5 3 .5 4x.25 .5 .25 3x.5 .25 2x.5 .25 .5 .25 .5 .25 .5 .25 .5 .25 .5 .25 .5 .25 .5 .25 1',
...
lead5 = E(Bright, '3.75r .5 .25 .5 .25 3x.5 .25 2x.5|3.75r .5 .25 .5 .25 .5 .25 .5 .25 .5 3x.25',
...
luke9 = E(Luke, '12r 16x.25 12.5r 14x.25',
